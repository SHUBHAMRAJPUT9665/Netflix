    ...
    <div class="faq">
        ...
        <ul class="accordion">
            ...
            <li>
                ...
                <div class="content"><p>{lang[langKey].faq2p}</p>
            </div>
            </li>
            ...
            <li>
                ...
                <div class="content"><p>{lang[langKey].faq4p}</p>
            </div>
            </li>
            ...
            <li>
                ...
                <div class="content">{lang[langKey].faq5pl}<p>
            ...
            <li>
                ...
                <div class="content"><p>{lang[langKey].faq6p}</p>
            </div>
            </li>
        </ul>
