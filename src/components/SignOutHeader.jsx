...
function SignOutHeader() {
  ...
  return (
    <div className=''>
      {user?
     <div className='px-1 pt-0 absolute z-10 flex justify-between items-center w-full'>
     ...
     <div className='cursor-pointer flex items-center'> 
         <button onClick={handleGptSearchClick} className='py-1 px-2  bg-red-700 flex justify-end rounded-md mx-4'>Search</button>
